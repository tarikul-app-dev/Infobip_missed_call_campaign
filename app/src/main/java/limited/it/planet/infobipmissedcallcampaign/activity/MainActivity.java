package limited.it.planet.infobipmissedcallcampaign.activity;
...
import limited.it.planet.infobipmissedcallcampaign.fragments.AppFragment;
import limited.it.planet.infobipmissedcallcampaign.fragments.DashboardFragment;
import limited.it.planet.infobipmissedcallcampaign.fragments.SettingsFragment;
import limited.it.planet.infobipmissedcallcampaign.fragments.ViewLog;
...
public class MainActivity extends AppCompatActivity implements ToolbarUI{
    ...
    public void addBottomNavigationItems(){
        ...
        final BottomNavigationItem bottomNavigationItem2 = new BottomNavigationItem
                ("View Log", ContextCompat.getColor(this, R.color.colorActive), R.drawable.ic_log_info);
...
//                    break;
    ...
    public void setToolbarType(String type) {
        ...
        else if (type == "viewlog") {

            headerText.setText("View Log");
            //headerText.setVisibility(View.VISIBLE);
